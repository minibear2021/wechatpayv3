...
def guides_register(self, corpid, store_id, userid, name, mobile, qr_code, avatar, group_qrcode=None):
    ...
    :param name: 企业微信的员工姓名, 需使用微信支付平台公钥加密, 示例值：'pVd1HJ6v/69bDnuC4EL5Kz4jBHLiCa8MRtelw/wDa4SzfeespQO/0kjiwfqdfg=='
    :param mobile: 手机号码, 使用微信支付平台公钥加密, 示例值：'pVd1HJ6v/69bDnuC4EL5Kz4jBHLiCa8MRtelw/wDa4SzfeespQO/0kjiwfqdfg=='
...
def guides_update(self, guide_id, name=None, mobile=None, qr_code=None, avatar=None, group_qrcode=None):
    ...
    :params name: 服务人员姓名, 该字段需加密，示例值：'pVd1HJ6v/69bDnuC4EL5Kz4jBHLiCa8MRtelw/wDa4SzfeespQO/0kjiwfqdfg=='
    :params mobile: 服务人员手机号码, 该字段需加密，示例值：'pVd1HJ6v/69bDnuC4EL5Kz4jBHLiCa8MRtelw/wDa4SzfeespQO/0kjiwfqdfg=='
