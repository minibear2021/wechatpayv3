...
async def fapiao_title_url(self, fapiao_apply_id, source, total_amount, openid, appid=None,
...
async def fapiao_applications(self, fapiao_apply_id, buyer_information, fapiao_information, scene='WITH_WECHATPAY'):
    """开具电子发票
    :param fapiao_apply_id: 发票申请单号，示例值：'4200000444201910177461284488'
...
async def fapiao_insert_cards(self, fapiao_apply_id, buyer_information, fapiao_card_information, scene='WITH_WECHATPAY'):
    """将电子发票插入微信用户卡包
    :param fapiao_apply_id: 发票申请单号，示例值：'4200000444201910177461284488'
...
async def fapiao_check_submch(self, sub_mchid):
    """检查子商户开票功能状态
...
async def fapiao_query_files(self, fapiao_apply_id, sub_mchid=None, fapiao_id=None):
    """获取发票下载信息
...
async def fapiao_download_file(self, url, openid, invoice_code, invoice_no, fapiao_id, sub_mchid=None):
    """下载发票文件
