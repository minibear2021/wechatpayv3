...
async def marketing_partnership_build(self, idempotency_key, partner_type, business_type, partner_appid=None,
...
async def marketing_partnership_query(self, business_type, stock_id, partner_type=None, partner_appid=None,
...
async def marketing_paygift_activity_create(self, activity_base_info, award_send_rule, advanced_setting=None):
    """创建全场满额送活动
...
async def marketing_paygift_merchant_add(self, activity_id, add_request_no, merchant_id_list=[]):
    """新增活动发券商户号
    :param activity_id: 活动id，示例值:'10028001'
...
async def marketing_paygift_activity_list(self, offset=0, limit=20, activity_name=None, activity_status=None, award_type=None):
    """获取支付有礼活动列表
    :param offset:分页页码，页面从0开始。示例值:1
    :param limit: 分页大小，限制分页最大数据条目。示例值:20
...
async def marketing_paygift_merchant_delete(self, activity_id, merchant_id_list=[], delete_request_no=None):
    """删除活动发券商户号
    :param activity_id: 活动id，示例值:'10028001'
...
async def marketing_favor_stock_create(self,
                                 stock_name,
                                 belong_merchant,
...
async def marketing_favor_stock_send(self,
                               stock_id,
                               openid,
                               out_request_no,
                               stock_creator_mchid,
...
async def marketing_favor_stock_list(self,
                               stock_creator_mchid,
                               offset=0,
                               limit=10,
...
async def marketing_favor_user_coupon(self,
                                openid,
                                stock_id=None,
                                status=None,
                                creator_mchid=None,
...
async def marketing_busifavor_stock_create(self,
                                     stock_name,
                                     belong_merchant,
                                     goods_name,
                                     stock_type,
...
async def marketing_busifavor_coupon_use(self,
                                   coupon_code,
                                   use_time,
                                   use_request_no,
                                   stock_id=None,
...
async def marketing_busifavor_user_coupon(self,
                                    openid,
                                    stock_id=None,
                                    coupon_state=None,
...
async def marketing_busifavor_couponcode_upload(self,
                                          stock_id,
                                          upload_request_no,
                                          coupon_code_list=[]):
    """上传预存code
...
async def marketing_busifavor_coupon_associate(self, stock_id, coupon_code, out_trade_no, out_request_no):
    """关联订单信息
    :param stock_id: 批次号。示例值:1212
    :param coupon_code: 券code，券的唯一标识。示例值:'sxxe34343434'
...
async def marketing_busifavor_coupon_disassociate(self, stock_id, coupon_code, out_trade_no, out_request_no):
    """取消关联订单信息
    :param stock_id: 批次号。示例值:1212
    :param coupon_code: 券code，券的唯一标识。示例值:'sxxe34343434'
    :param out_trade_no: 关联的商户订单号，微信支付下单时的商户订单号，欲与该商家券关联的微信支付。示例值:'MCH_102233445'
...
async def marketing_busifavor_stock_budget(self,
                                     stock_id,
...
async def marketing_busifavor_stock_modify(self,
                                     stock_id,
                                     out_request_no,
                                     custom_entrance=None,
                                     comment=None,
...
async def marketing_busifavor_coupon_deactivate(self, coupon_code, stock_id, deactivate_request_no, deactivate_reason=None):
    """使券失效
    :param coupon_code: 券code，券的唯一标识。示例值:'sxxe34343434'
    :param stock_id: 批次号。示例值:1212
...
async def marketing_busifavor_subsidy_pay(self,
                                    stock_id,
                                    coupon_code,
                                    transaction_id,
                                    payer_merchant,
...
async def industry_coupon_token(self, open_id, coupon_list=[]):
    """出行券切卡组件预下单
...
async def bank_package_file(self, package_id, bank_type, filepath):
    ...
    return await self._core.request(path, method=RequestType.POST, data=params, sign_data=params.get('meta'), files=files)
