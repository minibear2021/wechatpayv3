...
async def guides_register(self, corpid, store_id, userid, name, mobile, qr_code, avatar, group_qrcode=None, sub_mchid=None):
    """服务人员注册
...
async def guides_query(self, store_id, userid=None, mobile=None, work_id=None, limit=None, offset=0, sub_mchid=None):
    """服务人员查询
...
async def guides_update(self, guide_id, name=None, mobile=None, qr_code=None, avatar=None, group_qrcode=None, sub_mchid=None):
    """服务人员信息更新
    ...
    if self._partner_mode and sub_mchid:
        params.update({'sub_mchid': sub_mchid})
    return await self._core.request(path, method=RequestType.PATCH, data=params, cipher_data=cipher_data)
