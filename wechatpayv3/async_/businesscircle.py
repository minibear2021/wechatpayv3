...
async def points_notify(self, transaction_id, openid, earn_points, increased_points, points_update_time, no_points_remarks=None, total_points=None, appid=None, sub_mchid=None):
    """智慧商圈积分同步
...
async def business_parking_sync(self, openid, brandid, plate_number, state, time, appid=None, sub_mchid=None):
    """商圈会员停车状态同步
    :param openid: 用户标识，示例值:'oWmnN4xxxxxxxxxxe92NHIGf1xd8'
