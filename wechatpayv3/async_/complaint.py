...
async def complaint_list_query(self, begin_date=None, end_date=None, limit=10, offset=0, complainted_mchid=None):
    """查询投诉单列表
...
async def complaint_response(self, complaint_id, response_content, response_images=None, jump_url=None, jump_url_text=None, mini_program_jump_info=None):
    """提交投诉回复
    :param complaint_id: 投诉单对应的投诉单号。示例值:'200201820200101080076610000'
...
async def complaint_update_refund(self, complaint_id, action, launch_refund_day=None, reject_reason=None, reject_media_list={}, remark=None):
    """更新退款审批结果
